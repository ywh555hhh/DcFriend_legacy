...
try:
    ...
    print(f"FATAL: Could not load configuration. Please ensure a .env file exists in the project root and contains all required variables. Details: {e}", file=sys.stderr)
    sys.exit(1)